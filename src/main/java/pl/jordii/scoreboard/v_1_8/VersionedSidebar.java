...
public class VersionedSidebar extends SidebarVersionTemplate {
     ...
     */
    @Override
    public void renderSidebar(KelpSidebar<?> sidebar, Player player) {
...
//            sidebarRepository.addAnimatedSidebar(animatedSidebar, kelpPlayer);
     ...
     */
    @Override
    public void lazyUpdate(KelpSidebar<?> sidebar, Player player) {
     ...
     */
    @Override
    public void updateSidebar(KelpSidebar<?> sidebar, Player kelpPlayer) {
        Scoreboard scoreboard = kelpPlayer.getScoreboard();
