...
import pl.jordii.scoreboard.scheduler.KelpSchedulerRepository;
import pl.jordii.scoreboard.scheduler.KelpSchedulerRunnable;
...
public class RepeatingScheduler {
  ...
  public static RepeatingScheduler create() {
    return new RepeatingScheduler(
      KelpSchedulerRepository.getInstance()
    );
  }
