...
public class RepeatingScheduler {
  ...
  RepeatingScheduler(SchedulerRepository kelpSchedulerRepository) {
  ...
  /**
   * Finally starts the scheduler and registers it in the {@link SchedulerRepository}.
   * The repository assigns an id to each scheduler, which enables you to cancel it later
   * using {@link SchedulerRepository#interruptScheduler(UUID)}.
   *
